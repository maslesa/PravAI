  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setError("Došlo je do greške prilikom obrade pitanja.");
      }
    } finally {
      setLoading(false);
    }
      ...
      <header className="border-b border-mybg bg-mybg">
        <div className="mx-auto flex max-w-5xl items-center justify-center px-6 py-4">
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs text-mytxt/50">Legal Research Assistant</p>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-mytxt sm:text-5xl">
            Istražite zakone
            <br />
            <span className="text-mytxt-light/70">uz pomoć PravAI</span>
          </h2>

          <p className="mx-auto mt-5 max-w-2xl text-base text-mytxt">
            Postavite pitanje o zakonima Republike Srbije. PravAI pronalazi
            relevantne odredbe i generiše odgovor zasnovan na dostupnim
            izvorima.
          </p>
        </div>
        ...
        <div className="mt-16 border-t-2 border-mytxt pt-6 text-center">
          <p className="text-xs leading-5 text-mytxt/50">
            PravAI je alat za pravno istraživanje i informisanje. Ne predstavlja
            pravni savet niti zamenu za kvalifikovanog pravnika.
          </p>
        </div>
      </main>
    </div>
